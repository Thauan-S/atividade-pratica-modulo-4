 ...
 <jsp:include page="../../components/menu.jsp">
  ...
  <main>
      ...
      <div class="container formulario">
        <form action="../../pacote-create">
			  <div class="form-floating">
            
          </div>
          <div class="form-floating mt-4">
            <textarea class="form-control" name="destino" placeholder="Leave a comment here" id="floatingTextarea"></textarea>
            <label for="floatingTextarea">Destino</label>
          </div>
         
          <div class="form-floating">
            <textarea class="form-control mt-1" name="descricao" placeholder="Leave a comment here" id="floatingTextarea2"
              style="height: 100px"></textarea>
            <label for="floatingTextarea2">Descrição </label>
          </div>
          <div class="form-floating">
            <textarea class="form-control mt-1" name="duracao" placeholder="Leave a comment here" id="floatingTextarea2"
              style="height: 100px"></textarea>
            <label for="floatingTextarea2">Duracão em Dias </label>
          </div>
           <div class="form-floating">
            <textarea class="form-control mt-1" name="preco" placeholder="Leave a comment here" id="floatingTextarea2"
              style="height: 100px"></textarea>
